...
/* 
necesito que este carousel tome imagenes de las ciudades de forma aleatoria:
export default function Carousel() {
    const cities =  useSelector( (store) => store.cities.data ); 
...
el backend me devuelve en este formato:
{   name: String,
        country: String,
        description: String,
        imageURL: String  ,
